...
namespace BTOC.DAL
{
    public class SqlHelper
    {
        ...
        public static int ExecuteDeleteQuery(string connectionString, string deleteText, int userId)
        {
            ...
            if (0 != strDeleteText.IndexOf("DELETE", StringComparison.Ordinal)) return -1;

            // DELETE FROM table WHERE c1 = v1 AND ...
            int iStartIndex = strDeleteText.IndexOf("FROM", StringComparison.Ordinal) + "FROM ".Length;
            int iEndIndex = strDeleteText.IndexOf("WHERE", StringComparison.Ordinal);
            ...
            var oParam = new SqlParameter("@UserID", userId);
